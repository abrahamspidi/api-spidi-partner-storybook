...
Method: **POST**
```
{{base_url}}api/immediate-debit/get-token
```

**Headers:**
```
Content-Type: application/json
ClienteCod: b92410ac14a2af03fe270d...
Authorization: Bearer mrF3ISWe8Sv0bPU...
```
...
<table>
  ...
  <tr>
    <td><b>ClienteCod</b></td>
    <td><b>string</b></td>
    <td><b>Configuración del sistema</b></td>
    <td>
      <b>Valor fijo:</b> <i><b>"b92410ac14a2af03fe270d..."</b></i><br/>
      Código del cliente configurado en el sistema
    </td>
  </tr>
  <tr>
    <td><b>Authorization</b></td>
    <td><b>string</b></td>
    <td><b>Token de autenticación</b></td>
    <td>
      <b>Bearer token:</b> <i><b>"Bearer mrF3ISWe8Sv0bPU..."</b></i><br/>
...
```json
{
  "result": "Aceptada",
  "success": true,
  "message": "Token para débito solicitado con éxito.",
  "codigo": "200",
  "statusCode": 200
}
```

## 6.1. Ejemplos de Response 202 de SOFITASA (Token generado)
...
## 7. Tabla Explicativa de cada campo del response 202 de SOFITASA

### 7.1. Campos de nivel raíz(Response 202)
...
<table>
  ...
  <tr>
    ...
    <td><b>string</b></td>
    <td>
      <b>Generado.</b> <i><b>"Aceptada"</b></i> indica que la solicitud fue aceptada para procesamiento.
    </td>
  </tr>
  <tr>
    <td><b>success</b></td>
    <td><b>boolean</b></td>
    <td>
      <b>Generado.</b> <i><b>True</b></i> si la solicitud fue aceptada, <i><b>false</b></i> de lo contrario.
    </td>
  </tr>
  <tr>
    <td><b>message</b></td>
...
<table>
  ...
  <tr>
    <td><b>token</b></td>
    <td><b>string</b></td>
    <td><b>Token generado por el sistema</b></td>
    <td>
      <b>Token JWT generado:</b> <i><b>"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."</b></i><br/>
      Token de autenticación JWT generado por la plataforma SPIDI
    </td>
  </tr>
</table>
