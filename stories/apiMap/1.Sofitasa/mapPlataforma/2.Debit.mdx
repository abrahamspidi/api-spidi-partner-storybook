...
Method: **POST**
```
{{baseUrl}}api/spidi/transactions
```
...
Method: **POST**
```
{{baseUrl}}api/immediate-debit/run-debit
```
...
```json
{
    ...
    "debitorBank": "0137",
    "debitorID": "V19236967",
    "debitorAccount": "013700125400082592812",
    "debitorName": "Rafael",
