...
Method: **POST**
```
{{baseUrl}}/api/v1/payment-stops/links/batch
```
...
Después de ejecutar un batch, puedes verificar el estado actualizado de múltiples Paradas usando `POST {{baseUrl}}/api/v1/payment-stop/links/query`.
