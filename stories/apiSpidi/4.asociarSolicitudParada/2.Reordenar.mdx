...
Method: **PATCH**
```
{{base_url}}/api/v1/ext/payment-stops/reorder
```
...
* **Validaciones previas:** en `strict`, primero consulta `GET {{base_url}}/payment-stop/{stop_id}/links?status=pending` para conocer el conjunto activo actual.
