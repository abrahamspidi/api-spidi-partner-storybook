...
Method: **POST**
```
"{{base_url}}/api/v1/payment-sessions/button"
```
...
## 3.1 Ejemplo con Split por Porcentaje
...
## 3.2 Ejemplo con Split por Montos Absolutos
...
<tr><td><b><i>split</i></b></td><td><b><i>object</i></b></td><td>❌ No</td><td>Configuración de división de pagos (porcentaje o montos absolutos). Solo puede tener un valor si el agreement asociado está configurado en Split = Session</td></tr>
</table>
