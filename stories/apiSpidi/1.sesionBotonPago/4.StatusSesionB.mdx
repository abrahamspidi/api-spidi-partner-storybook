...
<Meta title="API-SPIDI/Sesion Boton de Pago/4. Status Sesion B" />
...
Method: **GET**
```
{{base_url}}/api/v1/ext/payment-sessions/{session_id}/status
```
...
```
{{base_url}}/api/v1/ext/payment-sessions/status/{session_id}
```

# 3. Ejemplo del Request
Method: **GET**
```
{{base_url}}/api/v1/ext/payment-sessions/3ddc4cfb-c09a-43de-92c1-e4a069732e90/status
```
