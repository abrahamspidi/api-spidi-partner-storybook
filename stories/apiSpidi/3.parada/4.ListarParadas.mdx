...
<Meta title="API-SPIDI/Parada/4. Listar Paradas" />
...
Method: **GET**
```
{{base_url}}/api/v1/ext/payment-stops
```
...
Method: **GET**
```
{{base_url}}/api/v1/ext/payment-stops?status=active&q=caja&limit=20&offset=0&sort=created_desc
```
...
* Si necesitas los **enlaces** de una parada, utiliza el endpoint complementario: `GET /api/v1/ext/payment-stops/{stop_id}/links`.
