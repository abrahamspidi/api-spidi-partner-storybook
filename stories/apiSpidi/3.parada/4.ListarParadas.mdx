...
Header:  
GET https://api.spidi.com/api/v1/payment-stop?status=active&q=caja&limit=20&offset=0&sort=createddesc
...
| **stopurl** | **string** | **Generado.** URL permanente de la parada individual. |
...
| **linksactivecount** | **integer** | **Generado.** Número de enlaces activos en la parada. |
| **updatedat** | **string** | **Generado.** Fecha y hora de última actualización (ISO 8601). |
