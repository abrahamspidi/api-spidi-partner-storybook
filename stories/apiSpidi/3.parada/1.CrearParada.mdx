...
Method: **POST**
```
{{baseUrl}}/api/v1/payment-stops/batch
```
...
<tr><td><b>batch_id</b></td><td>string</td><td>✅ Sí</td><td><b>Generado.</b> Identificador único del lote</td></tr>
<tr><td><b>results</b></td><td>[objeto]</td><td>✅ Sí</td><td><b>Generado.</b> Lista del objeto con la información de las paradas creadas.</td></tr>
</table>
