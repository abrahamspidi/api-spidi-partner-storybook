...
**GET** {{baseUrl}}/api/v1/payment-stops/{stop\_id}/links
...
| **updated\_at** | **string** | Última actualización (ISO 8601). |
...
| **expired\_at** | **string** | Fecha/hora de expiración (solo si `status = expired`). |
