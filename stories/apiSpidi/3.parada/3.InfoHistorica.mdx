...
<Meta title="API-SPIDI/Parada/3. Info Historica" />
...
Method: **GET**
```
{{base_url}}/api/v1/ext/payment-stops/7f8b2c6a-4d19-45df-9a10-3e872aa812c1/links?status=pending&limit=20&offset=0
```
